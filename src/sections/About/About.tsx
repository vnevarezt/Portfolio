export function About() {
  return (
    <div style={{ padding: 'var(--pad-y) var(--pad-x) var(--pad-b)', maxWidth: 'min(720px, 100%)' }}>
      <div
        className="m"
      ...
      <p style={{ fontSize: 'var(--fs-17)', lineHeight: 1.6, color: 'var(--fg)', margin: 0 }}>
      ...
      <p style={{ fontSize: 'var(--fs-14)', lineHeight: 1.65, marginTop: 14, color: 'var(--fg-m)' }}>
